...
cp ${AARCH64}/lib/clang/${VER}/lib/aarch64-unknown-linux-gnu/* ${TMPDEST}/lib/clang/${VER}/lib/aarch64-unknown-linux-gnu || exit 1
cp ${ARMV7A}/lib/clang/${VER}/lib/armv7l-unknown-linux-gnueabihf/* ${TMPDEST}/lib/clang/${VER}/lib/armv7l-unknown-linux-gnueabihf || exit 1
mv ${TMPDEST} ${DEST}
